...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.FREQ_HZ {250000000} CONFIG.PROTOCOL {AXI4LITE}  ] $M_AXI_GP0
  set M_AXI_GP1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_GP1 ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.FREQ_HZ {250000000} CONFIG.PROTOCOL {AXI4LITE}  ] $M_AXI_GP1
  set S_AXI_HP0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_HP0 ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.ARUSER_WIDTH {0} CONFIG.AWUSER_WIDTH {0} CONFIG.BUSER_WIDTH {0} CONFIG.DATA_WIDTH {32} CONFIG.FREQ_HZ {250000000} CONFIG.ID_WIDTH {0} CONFIG.MAX_BURST_LENGTH {256} CONFIG.NUM_READ_OUTSTANDING {1} CONFIG.NUM_WRITE_OUTSTANDING {1} CONFIG.PHASE {0.000} CONFIG.PROTOCOL {AXI4} CONFIG.READ_WRITE_MODE {READ_WRITE} CONFIG.RUSER_WIDTH {0} CONFIG.SUPPORTS_NARROW_BURST {1} CONFIG.WUSER_WIDTH {0}  ] $S_AXI_HP0
  ...
  set_property -dict [ list CONFIG.ASSOCIATED_BUSIF {M_AXI_GP0:S_AXI_HP0:M_AXI_GP1:S_AXI_HP1} CONFIG.FREQ_HZ {250000000}  ] $user_clk
  set user_rstn [ create_bd_port -dir O -from 0 -to 0 -type rst user_rstn ]
  ...
  set_property -dict [ list CONFIG.ENABLE_ADVANCED_OPTIONS {1} CONFIG.NUM_MI {10} CONFIG.S00_HAS_DATA_FIFO {0}  ] $GPIC0
  ...
  set_property -dict [ list CONFIG.NUM_MI {1} CONFIG.NUM_SI {2}  ] $HPIC3
  ...
  set_property -dict [ list CONFIG.C_S0_AXI_HIGHADDR {0x83C0FFFF}  ] $NVMeHostController_0
...
CONFIG.PCW_S_AXI_HP0_DATA_WIDTH {64} CONFIG.PCW_S_AXI_HP2_DATA_WIDTH {64} \
CONFIG.PCW_UART1_PERIPHERAL_ENABLE {1} CONFIG.PCW_UIPARAM_DDR_ADV_ENABLE {1} \
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.521} CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {0.636} \
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 {0.540} CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 {0.621} \
...
CONFIG.PCW_UIPARAM_DDR_T_RAS_MIN {37.5} CONFIG.PCW_UIPARAM_DDR_T_RC {50.62} \
...
CONFIG.PCW_USE_S_AXI_HP2 {1} CONFIG.PCW_USE_S_AXI_HP3 {1} \
  ...
  connect_bd_intf_net -intf_net GPIC0_M08_AXI [get_bd_intf_ports M_AXI_GP0] [get_bd_intf_pins GPIC0/M08_AXI]
  connect_bd_intf_net -intf_net GPIC0_M09_AXI [get_bd_intf_ports M_AXI_GP1] [get_bd_intf_pins GPIC0/M09_AXI]
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_ports S_AXI_HP0] [get_bd_intf_pins axi_interconnect_2/S00_AXI]
  ...
  connect_bd_intf_net -intf_net S_AXI_HP1_1 [get_bd_intf_ports S_AXI_HP1] [get_bd_intf_pins HPIC3/S01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins PS/S_AXI_HP2] [get_bd_intf_pins axi_interconnect_2/M00_AXI]
  ...
  connect_bd_net -net ARESETN_2 [get_bd_pins HPIC3/ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins proc_sys_reset_3/interconnect_aresetn]
  ...
  connect_bd_net -net M00_ARESETN_2 [get_bd_ports user_rstn] [get_bd_pins GPIC0/M08_ARESETN] [get_bd_pins GPIC0/M09_ARESETN] [get_bd_pins HPIC3/M00_ARESETN] [get_bd_pins HPIC3/S00_ARESETN] [get_bd_pins HPIC3/S01_ARESETN] [get_bd_pins NVMeHostController_0/m0_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins proc_sys_reset_3/peripheral_aresetn]
  ...
  connect_bd_net -net PS_FCLK_CLK3 [get_bd_ports user_clk] [get_bd_pins GPIC0/M08_ACLK] [get_bd_pins GPIC0/M09_ACLK] [get_bd_pins HPIC3/ACLK] [get_bd_pins HPIC3/M00_ACLK] [get_bd_pins HPIC3/S00_ACLK] [get_bd_pins HPIC3/S01_ACLK] [get_bd_pins NVMeHostController_0/m0_axi_aclk] [get_bd_pins PS/FCLK_CLK3] [get_bd_pins PS/S_AXI_HP0_ACLK] [get_bd_pins PS/S_AXI_HP1_ACLK] [get_bd_pins PS/S_AXI_HP2_ACLK] [get_bd_pins PS/S_AXI_HP3_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins proc_sys_reset_3/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins CH0MMCMC1H200/reset] [get_bd_pins CH2MMCMC1H200/reset] [get_bd_pins CH3MMCMC1H200/reset] [get_bd_pins Tiger4NSC_0/iReset] [get_bd_pins Tiger4NSC_1/iReset] [get_bd_pins Tiger4NSC_2/iReset] [get_bd_pins Tiger4NSC_3/iReset] [get_bd_pins Tiger4SharedKES_0/iReset] [get_bd_pins V2NFC100DDR_0/iReset] [get_bd_pins V2NFC100DDR_1/iReset] [get_bd_pins V2NFC100DDR_2/iReset] [get_bd_pins V2NFC100DDR_3/iReset] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net proc_sys_reset_1_peripheral_reset [get_bd_pins CH4MMCMC1H200/reset] [get_bd_pins CH6MMCMC1H200/reset] [get_bd_pins CH7MMCMC1H200/reset] [get_bd_pins Tiger4NSC_4/iReset] [get_bd_pins Tiger4NSC_5/iReset] [get_bd_pins Tiger4NSC_6/iReset] [get_bd_pins Tiger4NSC_7/iReset] [get_bd_pins Tiger4SharedKES_1/iReset] [get_bd_pins V2NFC100DDR_4/iReset] [get_bd_pins V2NFC100DDR_5/iReset] [get_bd_pins V2NFC100DDR_6/iReset] [get_bd_pins V2NFC100DDR_7/iReset] [get_bd_pins proc_sys_reset_1/peripheral_reset]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C80000 [get_bd_addr_spaces PS/Data] [get_bd_addr_segs M_AXI_GP0/Reg] SEG_M_AXI_GP0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C90000 [get_bd_addr_spaces PS/Data] [get_bd_addr_segs M_AXI_GP1/Reg] SEG_M_AXI_GP1_Reg
  create_bd_addr_seg -range 0x20000 -offset 0x83C00000 [get_bd_addr_spaces PS/Data] [get_bd_addr_segs NVMeHostController_0/s0_axi/reg0] SEG_NVMeHostController_0_reg0
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces S_AXI_HP0] [get_bd_addr_segs PS/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_PS_HP2_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces S_AXI_HP1] [get_bd_addr_segs PS/S_AXI_HP3/HP3_DDR_LOWOCM] SEG_PS_HP3_DDR_LOWOCM
